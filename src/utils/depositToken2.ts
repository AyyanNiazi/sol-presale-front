...
export const depositToken2 = async (
  ...
  */
  ...
  //   presalePDA
  // );
  // true, "confirmed", {}, TOKEN_PROGRAM_ID, ASSOCIATED_TOKEN_PROGRAM_ID;
  ...
  //   TOKEN_2022_PROGRAM_ID
  // );
  // console.log(tokenAta.address.toBase58());
  ...
  // const presaleVault = await getOrCreateAssociatedTokenAccount()
  ...
  const sender = await getAssociatedTokenAddressSync(
    mintKey,
    adminWallet,
    true,
    TOKEN_2022_PROGRAM_ID
  ...
  // console.log("sender ata already created: ", senderAtaInstruction.init);
  ...
  console.log(
    tokenAtaInstruction.address.toBase58() == toAta.toBase58(),
    toAta.toBase58()
  );
  ...
  // const fata = new PublicKey("BPmcsNLyQjKZdUyyyY9oddVj2hZkLbDELPurgzELaCvT");
  // console.log(sender.toBase58(), sender.toBase58() == fata.toBase58());
  const context = {
    mintAccount: mintKey,
    fromAssociatedTokenAccount: sender,
